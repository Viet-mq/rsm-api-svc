...
@Service
public class SendRoundEmailToRelatedPeopleService extends BaseService implements SendEmailService {

    protected SendRoundEmailToRelatedPeopleService(MongoDbOnlineSyncActions db) {
        super(db);
    }
