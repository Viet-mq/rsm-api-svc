...
@Service
public class SendCalendarEmailToPresenterService extends BaseService implements SendEmailService {

    protected SendCalendarEmailToPresenterService(MongoDbOnlineSyncActions db) {
        super(db);
    }
