...
@Service
class SendRoundEmailToInterviewerService extends BaseService implements SendEmailService {

    protected SendRoundEmailToInterviewerService(MongoDbOnlineSyncActions db) {
        super(db);
    }
