...
public interface ProfileService {
    ...
    GetArrayResponse<ProfileEntity> findAll(HeaderInfo info, String fullName, String talentPool, String job, String levelJob, String department, String recruitment, String calendar, String statusCV, String key, String tag, Long from, Long to, Integer page, Integer size);
