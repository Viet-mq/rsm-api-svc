...
@Service
public class SendRejectEmailToRelatedPeopleService extends BaseService implements SendEmailService {


    protected SendRejectEmailToRelatedPeopleService(MongoDbOnlineSyncActions db) {
        super(db);
    }
