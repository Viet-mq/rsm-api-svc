...
@Service
public class SendRoundEmailToPresenterService extends BaseService implements SendEmailService {

    protected SendRoundEmailToPresenterService(MongoDbOnlineSyncActions db) {
        super(db);
    }
