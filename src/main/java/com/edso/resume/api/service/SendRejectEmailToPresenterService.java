...
@Service
public class SendRejectEmailToPresenterService extends BaseService implements SendEmailService {


    protected SendRejectEmailToPresenterService(MongoDbOnlineSyncActions db) {
        super(db);
    }
