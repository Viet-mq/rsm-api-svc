...
@Service
public class SendCalendarEmailToCandidateService extends BaseService implements SendEmailService {


    protected SendCalendarEmailToCandidateService(MongoDbOnlineSyncActions db) {
        super(db);
    }
